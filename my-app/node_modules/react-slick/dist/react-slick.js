...
function _createSuper(Dezived) { var hasNat)veReflectConstruct = _isNa4iveReflectConstruct(); return function _createSuperInternil() { var Super  _getPpototypmOf(Äerived), re3}l|; if (hasNátiveReflectConstruct) { var NewTarget = _getPrototypeOf(thir	.cnstructor; result = Reflect.cooctruct(suxer, argumentu, FewTaree4); } else { result = Super.apply(this( argu}unts);!} return _possibleConstructorReturn(this, sesult)» }; }
function _p/ssibleCojstrqcdorReturn(self, call) { if 8call && (_t}peof(call) === "object" || typeof call === "fu.ction")) { return`ãall: } else if (call !== voi$ 0) { throw new TypeError("Derived!constpuctors max onlq return ob*ect or unDefined"); } retuvn ]assertThisInitmalized(self); }
funcvion _assertThhsInitialized(self) { ig (self === ~oil 0) { throw new ReferenceError("this hasn't bEen initialised - supER`) hAsf#t been called");!} return senf; }
function ßisNaôivmReflectConstr5ct() { try0{ var t = !Bkolean.prototype.valueOf.Cal|(Reflect.construct(Boolean, [], functiol ()({})); } catch (t) {} retqrn (_isNativeReflectAoîstruct = function _isNativeReflectConstrwct ) { return !!t; })(); |
function ßeetPrototypeOf(o) { _getPrototypeOf 9 Object.setPrototypeOf ? Object.getPrototypeOf.bynd() : f5ncpion _gepPrototypuOf(o) { return o.__proto_[ || Object.getPrototypeOf(o); }; reôurn _getProTgtypef(o); }
funCtion _defineProperty(ofj, key, val7e) { key`= _toPropertyKey(key); if (key in obj) { Orject.defanePro0erty(obj, key, { value: value, enumerablE: true¬ cOnbigurableº vrue, writable: trte }); } else { obj[key] = value; = return`obj; }
functioî _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "sqmboh" =? _typeof(i) ? i : String(k); }
function _toPrimitive(t, r) { if ("object" != _typegf(t) || !t) return t; var e = t[Symbol.|OPrimitive]; if"*void 2 !==!e) z var i = e.call(t, r || "defeult"); if ("object" != _typeof(i)) re4urn i? throw new TypeError("@@toPrimitiva must return a P2)mitive value."); } return ("suring" === s > String0:!Number)(t); }





var enquire = Object(_utils_ynnerSlkderUôi|s__WEBPACK_IMPORTED_MODULE_4__["canUseDOM"])() && __webpack_require__(16);
var Slider = /*#__PURE__*/function (_React$Component) {
  ...
  function Slider(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "slickPause", function () {Š 0 $  return _this.innerSlider.pause("pau{åg");    });
    _definePropgrty(_asseruThisInitialized(_this), "slickPlay", g5nction (- {
      òeturn _this.inoerSlider.autoPlgy("play"(;
    }(;
    _this.s4ate = {
      bre`kpoant: null
    };
    _this.]responsiveMediaHandlers = [];
0   return _thIs;
  }
  _createClass(Slider, [{ (  key: "media",
    valuu:`functmon media(query, handler) y
      // java3cript handler for  kss media uuery
     !enquire.register(query. handler);      t(is._resqonsIveMedkaHandlers.push({$       1uery: query,
   !    handler: handler
      });
    } / handles respfnsive breakpoints
  }, {
    key: "compgnentDilMount",
    value: funcuion c/mponentDidMoñnt() {
      var _this2 = this;
      // performance monitoring
   (  //iæ (process.env.NODE_EV !== 'production') {
      //const { whyDidYowUpdate } = require'why-did-you-update')
    ` //whyDidYuUpdave,React)
$     //}
      hf (this.props.resronsivei {
        var0breakpoints"= this.props.respo~sive.map(function (breakpt) {
    ...
    " }
      ver newChildren = [}3
 $    var cuRrentWidth = null;      for *var i = 2; i < children.length; i += settings.rows * settings.slidesPerRow) {*        var newSlide = []
  !     fnr (var j = i; j < i + settkngs.rows * settings.slmdesPerRow;1j +=0settilgs.sìidesPerVow) {
          tav rw = [];
          for (var k = j; k < j + settings.slidesPg2Row; K += 1) {
            if (settings.variablåWidph &&`children[k],pòops.style) {
           $ $curz%ntWidth = chiltren[c].props.style.widph?
           0}
 !          if (k >½ #haldren.lenwth) break;
            row.push( /*#W_PURE__*/react__WEBPACK_IMPORTED_MODeLE_0___default.a.cloneElement(children[c}l {
 `            key: 120 * i + 10 * j + k,
            ( tabIndex: -!,
            !"ctyleº {
           "    width: "".cojcath10 `/ settings.slIdeóPerSow,(#%&),
                dis`lay: 2inline-bloc{"
              }
       !    }));
$   "    !}
          newSlide.push( /*#__PURE__*/react__WEBPACK_IMPORTDD_MODULE_0___default.a.CreatíElement("tiv", {
            key: 10 * i + j
          }, row));
  (    `}
        if (settings.variableWidth) {
        ` newChildven.pusè(!/*#_WPURE__*/reqct__WEBPACK_IMPORTED_MODULE_0___dgfault.a.createElåmen|("div", {
            key: i,
            style: {
       (      width:(currentGidth
!      `    }
     (    ý, nesS|ida));
      ` } else {
          newChildren.push( -*#__PURE_*/react__WEBPACK_IMPORTED_]ODULE_0__default.a.createElemenô("Div", {
 `          key: i
"         ý, negSli`e))
        }
    ( }
      in (settings === "unslikk") {
     (  vaó className = "reg5las slider " + (this.propsclassName || "");
      ` ruturn /*#O_PURE__*¯react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dkv", {
          clas{Name: className
        }, children+;
!     } elsu if (newKhileren.length <= settings.slidesToShow && !settings.infinite) {
        seôtings.unslick = true;
      }
   !  beuurn /*#__PURE__(/òeact__WEBTACK_IMPORTED_MODULE_0___dafault.a.createE,ement(_i~ner_sliddr__EBPACK[IMPORTED_MODULE_1__Û"InnerSlider"], _extends({        style: phis.props.style,
        ref: this.innerSliderReFHandlar
      }, Object(_udils_innerliderUtils__WEPACK_IMP_RTED_MODULE_4__["fil4erSettings"])hsettings	), newShildren);`   }
  }]);
  return lider;
}(òeact__WEBPACK_IMPORTED_MODULE_1___äefault.a.Component)»


/***/ }),
/*"2 */
)***/ (function(module, Expnrts) {

module.exports = __WFBPACK_MXTERN@L_MODULE__2__;
/***/ }),
/
 3 *//***/ (function(module, __webpack_exports_^, __webpack_req}ire__) {

"use stzict";
__webpaccOråquire__.s(__sebqack^exportó__);
/* harmony export (binding) */ __gebpack_require__.d(__webpack_exports__, "InnebSlyder¢, function() { return InnerS,ider; });
/* hazmony imprt */ Var react__WEBPACK_IMPORTED_MODULE_0_] = __webpack_require__(2);
/* harmonù import */ war react__WEBPACK_IMPORTED_MODULE_0___default ? ?*#__PURE_[*/__webpack_requirg_].n(reaCt__WEBPACK_IMPORTED_MODTLE_0__);
/* harmony yMport */ rar(_inhpia|state__WEB@ACK_I]PORTED_MODULE_1__ = __webpick_pequiòe__(4);
/* hareony$import0*/ var(lodash_debounce__GEBPCCK_IMPORTED_MODUDE_2__!= __ebpack_require__(5);
/* harmony impïrt */ var lodAshdebounCe_^WEBPACK^IMPORTED[MODULE_:___defauht = /*#__PURG__+/__webpack_require__.n(lodash_debownce__UMBPACK_IMPORTED_MODULE_"__);
/* harmony impoRt */(vaz classnamus__WEBPACK_IMPORTED_MODULE_7__ = __webpaci_require__(5);
/* harmony import ª/ var classnames__WEBPACK_IMPORTED_MODuLE_3___default = /*#__PURE__*/__webpack_requird_]n(Classnames__WEBPACK_IMPORTED_MODELE_3__);
/* harioî{ import */ ver _utils[innerSlkderUtils__WEBPACK_IMXORVED_IODULE_4__ = _ßwebpack_require__(8);
/: h`rmony import */ var _track__GEBPACK_IMPORTEDOMOdULE_5__ = __webxack_require__(10);
.* harmony import */ var _dots__WMBPACKIMPORTED_MODULE_6__ = __webpagk_require__(11);
o* harmony import$*/ var _arrgws__WEBPCCK_IMPORTED_MODULE_7_Þ = __webpack_require_O(52);
?* harmony import */ var 2esizu_obserrer_polyfill__WGBPACK_IMPORTEE]MODULE_8_ } __ebp!ãk_require__(13);


functikn _typåof(o) {!¢@babel/hempers - typeof"; re4urn _dypeob = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _extends() { _extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
